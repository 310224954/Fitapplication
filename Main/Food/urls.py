...
urlpatterns = [
	...
	#path("product_desc/<str:slug>/",ProductDetailView.as_view(), name="prod_desc"),	
	#re_path(r"^product_desc/(?P<slug>[-\w]+)/$",ProductDetailView.as_view(), name="prod_desc"),
	...
	path("meal_detail/<int:pk>/<int:ing_pk>",UpdateIngredientQuantity.as_view(), name="update_meal_quantity"),
